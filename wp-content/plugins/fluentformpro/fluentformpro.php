...
define('FLUENTFORMPRO_VERSION', '4.3.9');
...
if (!class_exists('FluentFormPro')) {
    ...
    class FluentFormPro
    {
        ...
        public function boot()
        {
            ...
            if (!defined('FLUENTFORM_HAS_NIA')) {
                return add_action('admin_notices', function () {
                    ...
                    $message = 'You are using old version of Fluent Forms. Please update to latest from your plugins list';
        ...
        public function adminHooks($app)
        {
             ...
             */
            add_filter('fluentform_slack_field_label_selection', function ($labels, $settings) {
