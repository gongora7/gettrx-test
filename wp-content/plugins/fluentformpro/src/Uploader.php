...
class Uploader extends FormHandler
{
    ...
    protected function copyToDefault($files)
    {
        ...
        foreach ($files as $file) {
            ...
            $destinationFilePath = apply_filters('fluentform_default_upload_path',$wpUploadDir['basedir'] . FLUENTFORM_UPLOAD_DIR, $this->form) ;
    ...
    public function getProcessedUrl($file, $location)
    {
        ...
        if ($location == 'wp_media') {
            ...
            $fileUrl = apply_filters('fluentform_default_file_upload_url',$wpUploadDir['baseurl'] . FLUENTFORM_UPLOAD_DIR, $this->form );
