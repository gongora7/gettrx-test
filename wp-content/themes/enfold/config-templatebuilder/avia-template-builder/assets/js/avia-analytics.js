    ...
    $.AviaAnalytics.prototype = {
        ...
        */
        register_gutenberg_events: async function ()
        {
            ...
            this.builder.on('avia-analytics-for-blocks-ready', function ()
            {
            ...
            this.unsubscribe = wp.data.subscribe(_.debounce(function ()
            {
                ...
                if (changed)
                {
                    obj.builder.trigger('avia-analytics-for-blocks-ready');
                }
            }, obj.delay));
        },
        ...
        convert_shortcodes: function (content = null)
        {
            ...
            $.ajax({
                ...
                success: function (response) 
                {
                    ...
                    setTimeout(function () 
                    {
                        $(obj.builder).trigger('avia-analytics-ready');
                    }, 100);
                }
            });
        },
        ...
        */
        ...
        {
            return this.alb.is('.avia-hidden') == false;
        },
