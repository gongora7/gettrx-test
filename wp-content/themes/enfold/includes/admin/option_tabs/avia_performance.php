...
$avia_elements[] = array(
			'slug'		=> 'performance',
			'name'		=> __( 'Disable Mobile CSS Animations', 'avia_framework' ),
			'desc'		=> __( 'Background image parallax and delayed CSS animations when an element comes in viewport had been restricted on mobile devices prior to Enfold 5.0 due to limited ressources on these devices. This has changed with modern devices. Activate this option if you still want to disable background image parallax and start most animations immediately when page has finished loading.', 'avia_framework' ),
			'id'		=> 'disable_mobile_css_animations',
			'type'		=> 'checkbox',
			'std'		=> '',
			'globalcss'	=> true
		 );
